...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Get in touch with DissolvaGum for support, questions, or feedback about our dissolvable, eco-friendly chewing gum.",
    type: "website",
    url: "https://dissolvagum.com/contact",
