      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            {/* Placeholder for Email Capture - simple form for now */}
            <form className="flex flex-col sm:flex-row gap-2">
              <input 
                type="email" 
                placeholder="Enter your email for 10% off" 
                className="flex-grow p-2 rounded-md bg-gray-700 dark:bg-gray-800 border border-gray-600 dark:border-gray-700 focus:ring-teal-500 focus:border-teal-500 text-sm"
              />
              <button 
                type="submit" 
                className="bg-teal-500 hover:bg-teal-600 text-white font-semibold py-2 px-4 rounded-md transition-colors text-sm"
              >
                Subscribe
              </button>
            </form>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/faq" className="hover:text-teal-400 transition-colors">FAQ</Link></li> {/* Added FAQ as a common link */}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/contact" className="hover:text-teal-400 transition-colors">Contact Us</Link></li> {/* Added Contact Us */}
            </ul>
          </div>
        </div>
